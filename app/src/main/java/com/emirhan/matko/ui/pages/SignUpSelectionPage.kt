...
@Composable
fun SignUpSelectionScreen(modifier: Modifier,navController: NavController,viewModel: AuthViewModel){
    Column(modifier
        .fillMaxSize()
        ...
        val authResultLauncher= rememberLauncherForActivityResult(
            ...
            onResult = { result ->
                ...
                try {
                        ...
                        viewModel.signInWithGoogle(idToken){isNewUSer ->
                            if (isNewUSer){
                                ...
                                navController.navigate("examSelection_screen"){
                                    popUpTo("signUpSelection_screen"){inclusive=true}
                                }
                            }else{
                                Toast.makeText(context,"Zaten bir hesabınız var", Toast.LENGTH_SHORT).show()
                    ...
                    Toast.makeText(context,"Google kayıt hatası: ${e.localizedMessage}", Toast.LENGTH_SHORT).show()
                }
            }
        )
            ...
            ModalBottomSheet(
                ...
                Column(modifier = Modifier
                    ...
                    Button(onClick = {
                        ...
                        Text("E-MAİL & ŞİFRE İLE KAYIT OL",
                            color = MaterialTheme.colorScheme.tertiary,
                            fontFamily = MatkoFontFamily,
                            fontWeight = FontWeight.SemiBold)
                    }
...
@Composable
fun SignUpSelectionPreview(){
    MatkoTheme(dynamicColor = false) {
        //SignUpSelectionScreen(modifier = Modifier, navController = NavController(context = LocalContext.current))
    }
}